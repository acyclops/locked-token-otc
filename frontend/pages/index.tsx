...
// const usdcAddress = '0x42C1808116D473c1Ce608CD61d432edAaB5A7245';
// const cortexAddress = '0xcF2F1350BB4d55b6fdeC462E546dB2E0728a1258';
// const lensAddress = '0xE144288FB5be46E87016EF254D8f94fc59701C58';
// const factoryAddress = '0x7208d1Ed13d7bd34BD092977935e006895c27770';
    ...
    <Layout style={{ background: grey[7] }}>
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          <h1 className={styles.title} style={{color:'white', fontSize:50}}> Trustless CRX OTC Desk </h1>
          <div style={{ display: 'flex' }}>
            ...
            <Button onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSeuRTsM_5GnIReHXP1eQE1lJZsNrkv0dgcmRAT2__fnBriQxw/viewform', '_blank')} style={{fontSize: 24, blockSize: '50%' }}>
              Help
            </Button>
          </div>
          <br />
