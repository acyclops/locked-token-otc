...
contract CortexLens {
    ...
    function getOfferInfo(ILockedCortexOffer offer)
        public
        view
        returns (
    ...
    {
        return (CORTEX.totalBalanceOf(address(offer)), offer.tokenWanted(), offer.amountWanted());
    }

    function getActiveOffersPruned(IOfferFactory factory) public view returns (ILockedCortexOffer[] memory) {
    ...
    {
        ILockedCortexOffer[] memory activeOffers = getActiveOffersPruned(factory);
